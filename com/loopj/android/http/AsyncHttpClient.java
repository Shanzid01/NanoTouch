...
public class AsyncHttpClient {
    ...
    class C14711 implements HttpRequestInterceptor {
        C14711() {
        }
    ...
    class C14722 implements HttpResponseInterceptor {
        C14722() {
        }
    ...
    public AsyncHttpClient() {
        ...
        this.httpClient.addRequestInterceptor(new C14711());
        this.httpClient.addResponseInterceptor(new C14722());
    ...
    public static String getUrlWithQueryString(String str, RequestParams requestParams) {
        ...
        if (str.indexOf("?") == -1) {
            return new StringBuilder(String.valueOf(str)).append("?").append(paramString).toString();
        }
        return new StringBuilder(String.valueOf(str)).append("&").append(paramString).toString();
    }
