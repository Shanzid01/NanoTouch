...
public class TestSession extends Session {
    ...
    private static synchronized void retrieveTestAccountsForAppIfNeeded() {
        synchronized (TestSession.class) {
            if (appTestAccounts == null) {
                ...
                request.setBatchEntryOmitResultOnSuccess($assertionsDisabled);
                bundle = new Bundle();
                bundle.putString("access_token", getAppAccessToken());
    ...
    private static synchronized TestAccount findTestAccountMatchingIdentifier(String str) {
        ...
        synchronized (TestSession.class) {
            ...
            Iterator it = appTestAccounts.values().iterator();
            do {
                if (!it.hasNext()) {
                    testAccount = null;
                    break;
            ...
            } while (!testAccount.getName().contains(str));
        }
        return testAccount;
    }
    ...
    private TestAccount createTestAccountAndFinishAuth() {
        ...
        bundle.putString(NativeProtocol.RESULT_ARGS_PERMISSIONS, getPermissionsString());
        bundle.putString("access_token", getAppAccessToken());
    ...
    private void deleteTestAccount(String str, String str2) {
        ...
        } else if (graphObject.getProperty(Response.NON_JSON_RESPONSE_PROPERTY) == Boolean.valueOf($assertionsDisabled) || graphObject.getProperty(Response.SUCCESS_KEY) == Boolean.valueOf($assertionsDisabled)) {
