...
public class WebDialog extends Dialog {
    ...
    class BuilderBase<CONCRETE extends BuilderBase<?>> {
    ...
    class C06361 implements OnCancelListener {
        C06361() {
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.spinner.setMessage(getContext().getString(C0572R.string.com_facebook_loading));
        this.spinner.setOnCancelListener(new C06361());
    ...
    private void createCrossImage() {
        ...
        this.crossImageView.setOnClickListener(new C06372());
        this.crossImageView.setImageDrawable(getContext().getResources().getDrawable(C0572R.drawable.com_facebook_close));
