...
public class Response {
    ...
    Response(Request request, HttpURLConnection httpURLConnection, FacebookRequestError facebookRequestError) {
        this(request, httpURLConnection, null, null, null, $assertionsDisabled, facebookRequestError);
    }
    ...
    public final <T extends GraphObject> GraphObjectList<T> getGraphObjectListAs(Class<T> cls) {
        ...
        return this.graphObjectList.castToListOf(cls);
    }
    ...
    public String toString() {
        ...
        try {
            ...
            format = FitnessActivities.UNKNOWN;
        }
    ...
    L_0x002e:
        ...
        if (r0 != 0) goto L_0x0117;
    L_0x0034:
        r2 = r3.get(r1);	 Catch:{ FacebookException -> 0x004e, JSONException -> 0x006b, IOException -> 0x0074, all -> 0x007d }
        if (r2 == 0) goto L_0x0082;
    L_0x003a:
        r0 = 0;
        r4 = 1;
        r0 = createResponsesFromStream(r2, r0, r9, r4);	 Catch:{ FacebookException -> 0x0113, JSONException -> 0x006b, IOException -> 0x0074, all -> 0x007d }
    ...
    private static Response createResponseFromObject(Request request, HttpURLConnection httpURLConnection, Object obj, boolean z, Object obj2) {
        ...
        if (obj == JSONObject.NULL) {
            return new Response(request, httpURLConnection, obj.toString(), null, z);
        }
