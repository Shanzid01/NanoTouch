...
public class AppEventsLogger {
    ...
    class C05283 implements Runnable {
        C05283() {
        }
    ...
    class C05316 implements Runnable {
        private final /* synthetic */ FlushReason val$reason;

        C05316(FlushReason flushReason) {
    ...
    class C05327 implements Callback {
        private final /* synthetic */ AccessTokenAppIdPair val$accessTokenAppId;
        ...
        C05327(AccessTokenAppIdPair accessTokenAppIdPair, Request request, SessionEventsState sessionEventsState, FlushStatistics flushStatistics) {
            this.val$accessTokenAppId = accessTokenAppIdPair;
    ...
    class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C05331();
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C05283(), 0, 15, TimeUnit.SECONDS);
            backgroundExecutor.scheduleAtFixedRate(new C05294(), 0, 86400, TimeUnit.SECONDS);
        }
    }
    ...
    private static void logEvent(Context context, AppEvent appEvent, AccessTokenAppIdPair accessTokenAppIdPair) {
        Settings.getExecutor().execute(new C05305(context, accessTokenAppIdPair, appEvent));
    }
    ...
    private static void flush(FlushReason flushReason) {
        Settings.getExecutor().execute(new C05316(flushReason));
    }
    ...
    L_0x0029:
        ...
        r0 = android.support.v4.content.C0090q.m145a(r0);
        r0.m150a(r1);
        goto L_0x0008;
    L_0x0048:
        r0 = move-exception;
    ...
    private static Request buildRequestForSession(AccessTokenAppIdPair accessTokenAppIdPair, SessionEventsState sessionEventsState, boolean z, FlushStatistics flushStatistics) {
        ...
        newPostRequest.setCallback(new C05327(accessTokenAppIdPair, newPostRequest, sessionEventsState, flushStatistics));
    ...
    static String getSourceApplication() {
        ...
        if (sourceApplication != null) {
            return new StringBuilder(String.valueOf(str)).append("(").append(sourceApplication).append(")").toString();
        }
        return str;
    }
