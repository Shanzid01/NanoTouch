...
public class AppLinkData {
    ...
    class C05341 implements Runnable {
        ...
        private final /* synthetic */ String val$applicationIdCopy;
        private final /* synthetic */ CompletionHandler val$completionHandler;

        C05341(Context context, String str, CompletionHandler completionHandler) {
    ...
    public static void fetchDeferredAppLinkData(Context context, String str, CompletionHandler completionHandler) {
        ...
        Settings.getExecutor().execute(new C05341(context.getApplicationContext(), str, completionHandler));
    }
    ...
    private static void fetchDeferredAppLinkFromServer(Context context, String str, CompletionHandler completionHandler) {
        ...
        Utility.setAppEventAttributionParameters(create, AttributionIdentifiers.getAttributionIdentifiers(context), Utility.getHashedDeviceAndAppID(context, str), Settings.getLimitEventAndDataUsage(context));
