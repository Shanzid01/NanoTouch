...
public class UiLifecycleHelper {
    ...
    private final C0090q broadcastManager;
    ...
    public UiLifecycleHelper(Activity activity, StatusCallback statusCallback) {
        ...
        this.broadcastManager = C0090q.m145a((Context) activity);
    ...
    public void onResume() {
        ...
        this.broadcastManager.m149a(this.receiver, intentFilter);
    }
    ...
    public void onPause() {
        this.broadcastManager.m148a(this.receiver);
        if (this.callback != null) {
            Session activeSession = Session.getActiveSession();
            if (activeSession != null) {
