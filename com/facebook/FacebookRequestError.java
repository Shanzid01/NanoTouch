    ...
    private FacebookRequestError(int i, int i2, int i3, String str, String str2, String str3, String str4, boolean z, JSONObject jSONObject, JSONObject jSONObject2, Object obj, HttpURLConnection httpURLConnection, FacebookException facebookException) {
        ...
        if (obj2 != null) {
            ...
            if (i2 == 1 || i2 == 2) {
                ...
                i5 = C0572R.string.com_facebook_requesterror_permissions;
                ...
                if (i3 == EC_USER_CHECKPOINTED || i3 == EC_UNCONFIRMED_USER) {
                    ...
                    i5 = C0572R.string.com_facebook_requesterror_web_login;
                } else {
                    category2 = Category.AUTHENTICATION_REOPEN_SESSION;
                    i5 = (i3 == EC_APP_NOT_INSTALLED || i3 == EC_EXPIRED) ? C0572R.string.com_facebook_requesterror_relogin : i3 == EC_PASSWORD_CHANGED ? C0572R.string.com_facebook_requesterror_password_changed : C0572R.string.com_facebook_requesterror_reconnect;
                }
            }
            if (category2 != null) {
                category = category2;
            ...
            if (jSONObject.has("code")) {
                ...
                if (!HTTP_RANGE_SUCCESS.contains(i)) {
                    if (jSONObject.has(BODY_KEY)) {
                        jSONObject2 = (JSONObject) Utility.getStringPropertyAsJSON(jSONObject, BODY_KEY, Response.NON_JSON_RESPONSE_PROPERTY);
                    } else {
                        jSONObject2 = null;
                    }
                    return new FacebookRequestError(i, -1, -1, null, null, null, null, false, jSONObject2, jSONObject, obj, httpURLConnection);
                }
            }
