...
public final class ObjectAnimator extends ValueAnimator {
    ...
    static {
        ...
        PROXY_PROPERTIES.put("x", PreHoneycombCompat.f2601X);
        PROXY_PROPERTIES.put("y", PreHoneycombCompat.f2602Y);
    }
    ...
    public void setObjectValues(Object... objArr) {
        if (this.mValues != null && this.mValues.length != 0) {
            ...
            setValues(PropertyValuesHolder.ofObject(this.mProperty, null, objArr));
        } else {
