...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C15851();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C15873();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C15884();
    private static final TypeEvaluator sFloatEvaluator = new FloatEvaluator();
    private static long sFrameDelay = 10;
    private static final TypeEvaluator sIntEvaluator = new IntEvaluator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C15862();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C15895();
    ...
    class C15851 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C15851() {
        }
    ...
    class C15862 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C15862() {
        }
    ...
    class C15873 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C15873() {
        }
    ...
    class C15884 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C15884() {
        }
    ...
    class C15895 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C15895() {
        }
