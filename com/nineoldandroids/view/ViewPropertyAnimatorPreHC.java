...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
    ...
    private static final int f2605X = 128;
    private static final int f2606Y = 256;
    private Runnable mAnimationStarter = new C15921();
    ...
    public ViewPropertyAnimator mo4217x(float f) {
    ...
    public ViewPropertyAnimator mo4219y(float f) {
    ...
    private void startAnimation() {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(TextTrackStyle.DEFAULT_FONT_SCALE);
