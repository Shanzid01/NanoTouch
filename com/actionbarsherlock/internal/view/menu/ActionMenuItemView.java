...
public class ActionMenuItemView extends LinearLayout implements OnClickListener, OnLongClickListener, View_HasStateListenerSupport, ActionMenuChildView, ItemView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAllowTextWithIcon = ResourcesCompat.getResources_getBoolean(context, C0414R.bool.abs__config_allowActionMenuItemTextWithIcon);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0414R.styleable.SherlockActionMenuItemView, 0, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0414R.styleable.SherlockActionMenuItemView_android_minWidth, 0);
    ...
    public void onFinishInflate() {
        this.mImageButton = (ImageButton) findViewById(C0414R.id.abs__imageButton);
        this.mTextButton = (CapitalizingButton) findViewById(C0414R.id.abs__textButton);
    ...
    private void updateTextButtonVisibility() {
        int i = 1;
        int i2 = 0;
        int i3 = TextUtils.isEmpty(this.mTextButton.getText()) ? 0 : 1;
