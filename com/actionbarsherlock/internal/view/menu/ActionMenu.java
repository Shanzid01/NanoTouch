...
public class ActionMenu implements Menu {
    ...
    private ActionMenuItem findItemWithShortcut(int i, KeyEvent keyEvent) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (z) {
                alphabeticShortcut = actionMenuItem.getAlphabeticShortcut();
            } else {
                alphabeticShortcut = actionMenuItem.getNumericShortcut();
            }
    ...
    public boolean performIdentifierAction(int i, int i2) {
        ...
        return ((ActionMenuItem) this.mItems.get(findItemIndex)).invoke();
    }
