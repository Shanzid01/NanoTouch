...
class KeyframeSet {
    ...
    public static KeyframeSet ofInt(int... iArr) {
        ...
        if (length == 1) {
            ...
            intKeyframeArr[1] = (IntKeyframe) Keyframe.ofInt(TextTrackStyle.DEFAULT_FONT_SCALE, iArr[0]);
        } else {
    ...
    public static KeyframeSet ofFloat(float... fArr) {
        ...
        if (length == 1) {
            ...
            floatKeyframeArr[1] = (FloatKeyframe) Keyframe.ofFloat(TextTrackStyle.DEFAULT_FONT_SCALE, fArr[0]);
        } else {
    ...
    public static KeyframeSet ofObject(Object... objArr) {
        ...
        if (length == 1) {
            ...
            keyframeArr[1] = (ObjectKeyframe) Keyframe.ofObject(TextTrackStyle.DEFAULT_FONT_SCALE, objArr[0]);
        } else {
    ...
    public String toString() {
        ...
        int i = 0;
        while (i < this.mNumKeyframes) {
            String stringBuilder = new StringBuilder(String.valueOf(str)).append(((Keyframe) this.mKeyframes.get(i)).getValue()).append("  ").toString();
            i++;
            str = stringBuilder;
        }
        return str;
