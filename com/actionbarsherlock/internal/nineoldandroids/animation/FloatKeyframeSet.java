...
class FloatKeyframeSet extends KeyframeSet {
    ...
    public float getFloatValue(float f) {
        ...
        if (this.mNumKeyframes == 2) {
            ...
            return ((Number) this.mEvaluator.evaluate(r0, Float.valueOf(r2), Float.valueOf(r3))).floatValue();
            ...
            while (i < this.mNumKeyframes) {
                ...
                if (f < r0.getFraction()) {
                    ...
                    r0 = r0.getFloatValue();
                    if (this.mEvaluator == null) {
                        return ((r0 - r2) * fraction) + r2;
                    }
                    return ((Number) this.mEvaluator.evaluate(fraction, Float.valueOf(r2), Float.valueOf(r0))).floatValue();
                }
                i++;
                floatKeyframe = r0;
            }
