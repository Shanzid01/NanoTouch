...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C04191();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C04213();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C04224();
    private static long sFrameDelay = 10;
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C04202();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C04235();
    ...
    class C04191 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C04191() {
        }
    ...
    class C04202 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C04202() {
        }
    ...
    class C04213 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C04213() {
        }
    ...
    class C04224 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C04224() {
        }
    ...
    class C04235 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C04235() {
        }
    ...
    boolean animationFrame(long j) {
        ...
        switch (this.mPlayingState) {
            ...
            case 2:
                float f;
                float f2 = this.mDuration > 0 ? ((float) (j - this.mStartTime)) / ((float) this.mDuration) : TextTrackStyle.DEFAULT_FONT_SCALE;
                if (f2 < TextTrackStyle.DEFAULT_FONT_SCALE) {
                    ...
                    if (this.mRepeatMode == 2) {
                        ...
                        this.mPlayingBackwards = z2;
                    }
                    this.mCurrentIteration += (int) f2;
                    f = f2 % TextTrackStyle.DEFAULT_FONT_SCALE;
                    this.mStartTime += this.mDuration;
                } else {
                    f = Math.min(f2, TextTrackStyle.DEFAULT_FONT_SCALE);
                    z = true;
                }
                if (this.mPlayingBackwards) {
                    f = TextTrackStyle.DEFAULT_FONT_SCALE - f;
                }
                animateValue(f);
                break;
        }
