...
public class IcsListPopupWindow {
    ...
    class C04331 implements OnItemSelectedListener {
        C04331() {
        }
    ...
    class DropDownListView extends ListView {
        ...
        public DropDownListView(Context context, boolean z) {
            super(context, null, C0414R.attr.dropDownListViewStyle);
            this.mHijackFocus = z;
            setCacheColorHint(0);
        }
    ...
    public IcsListPopupWindow(Context context) {
        this(context, null, C0414R.attr.listPopupWindowStyle);
    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mDropDownList.setOnItemSelectedListener(new C04331());
