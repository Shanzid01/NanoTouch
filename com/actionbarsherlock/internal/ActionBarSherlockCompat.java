...
public class ActionBarSherlockCompat extends ActionBarSherlock implements OnMenuItemClickListener, Callback, MenuPresenter.Callback, Window.Callback {
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        ...
        if (this.aActionBar != null) {
            startActionMode = this.aActionBar.startActionMode(actionModeCallbackWrapper);
        } else {
        ...
        if (startActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                ViewStub viewStub = (ViewStub) this.mDecor.findViewById(C0414R.id.abs__action_mode_bar_stub);
                if (viewStub != null) {
    ...
    private boolean initializePanelMenu() {
        ...
        if (this.wActionBar != null) {
            ...
            context.getTheme().resolveAttribute(C0414R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    private IcsProgressBar getCircularProgressBar(boolean z) {
        ...
        this.mCircularProgressBar = (IcsProgressBar) this.mDecor.findViewById(C0414R.id.abs__progress_circular);
        if (this.mCircularProgressBar != null) {
    ...
    private IcsProgressBar getHorizontalProgressBar(boolean z) {
        ...
        this.mHorizontalProgressBar = (IcsProgressBar) this.mDecor.findViewById(C0414R.id.abs__progress_horizontal);
        if (this.mHorizontalProgressBar != null) {
    ...
    private void installDecor() {
        ...
        if (this.mContentParent == null) {
            ...
            if (this.mTitleView == null) {
                this.wActionBar = (ActionBarView) this.mDecor.findViewById(C0414R.id.abs__action_bar);
                if (this.wActionBar != null) {
                    ...
                    if (z) {
                        resources_getBoolean = ResourcesCompat.getResources_getBoolean(this.mActivity, C0414R.bool.abs__split_action_bar_is_narrow);
                    } else {
                        resources_getBoolean = this.mActivity.getTheme().obtainStyledAttributes(C0414R.styleable.SherlockTheme).getBoolean(C0414R.styleable.SherlockTheme_windowSplitActionBar, false);
                    }
                    ActionBarContainer actionBarContainer = (ActionBarContainer) this.mDecor.findViewById(C0414R.id.abs__split_action_bar);
                    if (actionBarContainer != null) {
                        ...
                        this.mActionModeView = (ActionBarContextView) this.mDecor.findViewById(C0414R.id.abs__action_context_bar);
    ...
    private ViewGroup generateLayout() {
        TypedArray obtainStyledAttributes = this.mActivity.getTheme().obtainStyledAttributes(C0414R.styleable.SherlockTheme);
        this.mIsFloating = obtainStyledAttributes.getBoolean(C0414R.styleable.SherlockTheme_android_windowIsFloating, false);
        if (obtainStyledAttributes.hasValue(C0414R.styleable.SherlockTheme_windowActionBar)) {
            int i;
            if (obtainStyledAttributes.getBoolean(C0414R.styleable.SherlockTheme_windowNoTitle, false)) {
                requestFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0414R.styleable.SherlockTheme_windowActionBar, false)) {
                requestFeature(8);
            }
            if (obtainStyledAttributes.getBoolean(C0414R.styleable.SherlockTheme_windowActionBarOverlay, false)) {
                requestFeature(9);
            }
            if (obtainStyledAttributes.getBoolean(C0414R.styleable.SherlockTheme_windowActionModeOverlay, false)) {
                requestFeature(10);
            }
            obtainStyledAttributes.recycle();
            if (hasFeature(1)) {
                if (!hasFeature(10) || hasFeature(1)) {
                    i = C0414R.layout.abs__screen_simple;
                } else {
                    i = C0414R.layout.abs__screen_simple_overlay_action_mode;
                }
            } else if (this.mIsFloating) {
                this.mDecor = (ViewGroup) this.mDecor.getParent();
                this.mDecor.removeAllViews();
                i = C0414R.layout.abs__dialog_title_holo;
            } else if (hasFeature(9)) {
                i = C0414R.layout.abs__screen_action_bar_overlay;
            } else {
                i = C0414R.layout.abs__screen_action_bar;
            }
            this.mDecor.addView(this.mActivity.getLayoutInflater().inflate(i, null), new LayoutParams(-1, -1));
            ViewGroup viewGroup = (ViewGroup) this.mDecor.findViewById(C0414R.id.abs__content);
            if (viewGroup == null) {
