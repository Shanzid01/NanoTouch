...
class SuggestionsAdapter extends ai implements OnClickListener {
    ...
    final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0414R.id.edit_query);
        }
    }
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, ConstantState> weakHashMap) {
        super(context, C0414R.layout.abs__search_dropdown_item_icons_2line, null, true);
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        try {
            Cursor suggestions = getSuggestions(charSequence2, 50);
            if (suggestions != null) {
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0414R.attr.textColorSearchUrl, typedValue, true);
