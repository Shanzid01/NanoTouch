...
public final class zzad extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        ...
        switch (i) {
            case 0:
            case 1:
                zzb = zzb(i2, C0783R.drawable.common_signin_btn_text_dark, C0783R.drawable.common_signin_btn_text_light);
                break;
            case 2:
                zzb = zzb(i2, C0783R.drawable.common_signin_btn_icon_dark, C0783R.drawable.common_signin_btn_icon_light);
                break;
            default:
    ...
    private void zzc(Resources resources, int i, int i2) {
        setTextColor(resources.getColorStateList(zzb(i2, C0783R.color.common_signin_btn_text_dark, C0783R.color.common_signin_btn_text_light)));
        switch (i) {
            case 0:
                setText(resources.getString(C0783R.string.common_signin_button_text));
                return;
            case 1:
                setText(resources.getString(C0783R.string.common_signin_button_text_long));
                return;
            case 2:
                setText(null);
                return;
