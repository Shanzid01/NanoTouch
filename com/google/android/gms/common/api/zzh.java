...
public class zzh extends Fragment implements OnCancelListener, LoaderCallbacks<ConnectionResult> {
    ...
    class zza extends C0089o<ConnectionResult> implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    public C0089o<ConnectionResult> onCreateLoader(int i, Bundle bundle) {
        return new zza(getActivity(), ((zzb) this.zzNy.get(i)).zzNz);
    }

    public /* synthetic */ void onLoadFinished(C0089o c0089o, Object obj) {
        zza(c0089o, (ConnectionResult) obj);
    }

    public void onLoaderReset(C0089o<ConnectionResult> c0089o) {
    }
    ...
    public void zza(C0089o<ConnectionResult> c0089o, ConnectionResult connectionResult) {
        if (!connectionResult.isSuccess()) {
            zza(c0089o.getId(), connectionResult);
        }
    }
