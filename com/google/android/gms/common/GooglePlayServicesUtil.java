...
public final class GooglePlayServicesUtil {
    ...
    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        Intent zzan = zzan(i);
        return zzan == null ? null : PendingIntent.getActivity(context, i2, zzan, DriveFile.MODE_READ_ONLY);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        if (!zze.zzPq) {
            try {
                context.getResources().getString(C0783R.string.common_google_play_services_unknown_issue);
            } catch (Throwable th) {
            ...
            if ("Theme.Dialog.Alert".equals(activity.getResources().getResourceEntryName(typedValue.resourceId))) {
                ...
                switch (i) {
                    case 0:
                        return null;
                    case 1:
                        return builder.setTitle(C0783R.string.common_google_play_services_install_title).create();
                    case 2:
                        return builder.setTitle(C0783R.string.common_google_play_services_update_title).create();
                    case 3:
                        return builder.setTitle(C0783R.string.common_google_play_services_enable_title).create();
                    case 4:
                    case 6:
                        return builder.create();
                    case 5:
                        Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                        return builder.setTitle(C0783R.string.common_google_play_services_invalid_account_title).create();
                    case 7:
                        Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                        return builder.setTitle(C0783R.string.common_google_play_services_network_error_title).create();
                    case 8:
                        Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                        return builder.create();
                    case 9:
                        Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                        return builder.setTitle(C0783R.string.common_google_play_services_unsupported_title).create();
                    case 10:
                    ...
                    case 17:
                        ...
                        return builder.setTitle(C0783R.string.common_google_play_services_sign_in_failed_title).create();
                    case 42:
                        return builder.setTitle(C0783R.string.common_android_wear_update_title).create();
                    default:
    ...
    private static void zza(int i, Context context, String str) {
        ...
        CharSequence string = resources.getString(C0783R.string.common_google_play_services_error_notification_requested_by_msg, new Object[]{zzM(context)});
        PendingIntent errorPendingIntent = getErrorPendingIntent(i, context, 0);
        if (zzlu.zzQ(context)) {
            zzx.zzN(zzme.zzkh());
            build = new Notification.Builder(context).setSmallIcon(C0783R.drawable.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new BigTextStyle().bigText(zzg + " " + string)).addAction(C0783R.drawable.common_full_open_on_phone, resources.getString(C0783R.string.common_open_on_phone), errorPendingIntent).build();
        } else {
            Notification notification = new Notification(17301642, resources.getString(C0783R.string.common_google_play_services_notification_ticker), System.currentTimeMillis());
    ...
    public static String zze(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return zza(context.getResources()) ? resources.getString(C0783R.string.common_google_play_services_install_text_tablet) : resources.getString(C0783R.string.common_google_play_services_install_text_phone);
            case 2:
                return resources.getString(C0783R.string.common_google_play_services_update_text);
            case 3:
                return resources.getString(C0783R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0783R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0783R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0783R.string.common_google_play_services_unsupported_text);
            case 16:
                return resources.getString(C0783R.string.commono_google_play_services_api_unavailable_text);
            case 17:
                return resources.getString(C0783R.string.common_google_play_services_sign_in_failed_text);
            case 42:
                return resources.getString(C0783R.string.common_android_wear_update_text);
            default:
                return resources.getString(C0783R.string.common_google_play_services_unknown_issue);
        }
    }
    ...
    public static String zzf(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0783R.string.common_google_play_services_install_button);
            case 2:
            case 42:
                return resources.getString(C0783R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0783R.string.common_google_play_services_enable_button);
            default:
    ...
    public static String zzg(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0783R.string.f2126x8f024ee1);
            case 2:
                return resources.getString(C0783R.string.common_google_play_services_notification_needs_update_title);
            case 3:
                return resources.getString(C0783R.string.common_google_play_services_needs_enabling_title);
            case 5:
                return resources.getString(C0783R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0783R.string.common_google_play_services_network_error_text);
            ...
            case 17:
                return resources.getString(C0783R.string.common_google_play_services_sign_in_failed_text);
            case 42:
                return resources.getString(C0783R.string.common_android_wear_notification_needs_update_text);
            default:
                return resources.getString(C0783R.string.common_google_play_services_unknown_issue);
        }
    }
