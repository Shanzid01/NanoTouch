...
public interface zzns extends IInterface {
    ...
    public abstract class zza extends Binder implements zzns {

        class zza implements zzns {
            ...
            public void zza(zzf com_google_android_gms_fitness_result_zzf) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (zzf) zzf.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(zzf com_google_android_gms_fitness_result_zzf);
}
