...
public interface zzew extends IInterface {
    ...
    public abstract class zza extends Binder implements zzew {

        class zza implements zzew {
            ...
            public IBinder zzb(zzd com_google_android_gms_dynamic_zzd) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    IBinder zzb = zzb(com.google.android.gms.dynamic.zzd.zza.zzau(parcel.readStrongBinder()));
    ...
    IBinder zzb(zzd com_google_android_gms_dynamic_zzd);
}
