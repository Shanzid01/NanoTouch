...
public interface zzsv extends IInterface {
    ...
    public abstract class zza extends Binder implements zzsv {

        class zza implements zzsv {
            ...
            public void zza(zzsu com_google_android_gms_internal_zzsu, Uri uri, Bundle bundle, boolean z) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzsu.zza.zzcr(parcel.readStrongBinder()), parcel.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void zza(zzsu com_google_android_gms_internal_zzsu, Uri uri, Bundle bundle, boolean z);
}
