...
public interface zzfq extends IInterface {
    ...
    public abstract class zza extends Binder implements zzfq {

        class zza implements zzfq {
            ...
            public IBinder zzc(zzd com_google_android_gms_dynamic_zzd) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    IBinder zzc = zzc(com.google.android.gms.dynamic.zzd.zza.zzau(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzc);
                    return true;
                case 1598968902:
    ...
    IBinder zzc(zzd com_google_android_gms_dynamic_zzd);
}
