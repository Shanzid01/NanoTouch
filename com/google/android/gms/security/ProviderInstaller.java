...
public class ProviderInstaller {
    ...
    final class C14041 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzawN;
        final /* synthetic */ Context zznK;

        C14041(Context context, ProviderInstallListener providerInstallListener) {
            this.zznK = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C14041(context, providerInstallListener).execute(new Void[0]);
    }
