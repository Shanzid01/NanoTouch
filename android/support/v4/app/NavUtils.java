...
import android.support.v4.content.C0083i;
...
public class NavUtils {
    ...
    class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, componentName) == null ? C0083i.m140a(componentName) : new Intent().setComponent(componentName);
    ...
    public static Intent getParentActivityIntent(Context context, Class<?> cls) {
        ...
        return getParentActivityName(context, componentName) == null ? C0083i.m140a(componentName) : new Intent().setComponent(componentName);
    }
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) {
        ...
        return getParentActivityName(context, componentName2) == null ? C0083i.m140a(componentName2) : new Intent().setComponent(componentName2);
    }
