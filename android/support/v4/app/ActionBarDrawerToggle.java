...
import android.support.v4.widget.C0027p;
...
@Deprecated
public class ActionBarDrawerToggle implements C0027p {
    ...
    class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int i2 = ay.m588h(this.this$0.mActivity.getWindow().getDecorView()) == 1 ? 1 : 0;
            if (i2 != 0) {
                i = -1;
            }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mDrawerImage = C0028a.getDrawable(activity, i);
        this.mSlider = new SlideDrawable(this.mDrawerImage);
        this.mSlider.setOffset(z ? TOGGLE_DRAWABLE_OFFSET : 0.0f);
    }

    public void syncState() {
        if (this.mDrawerLayout.m960f(8388611)) {
            this.mSlider.setPosition(TextTrackStyle.DEFAULT_FONT_SCALE);
        } else {
            this.mSlider.setPosition(0.0f);
        }
        if (this.mDrawerIndicatorEnabled) {
            setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.m960f(8388611) ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
        }
    }
    ...
    public void setHomeAsUpIndicator(int i) {
        ...
        if (i != 0) {
            drawable = C0028a.getDrawable(this.mActivity, i);
        }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = C0028a.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.m962g(8388611)) {
            this.mDrawerLayout.m959e(8388611);
        } else {
            this.mDrawerLayout.m957d(8388611);
        }
        return true;
    }
