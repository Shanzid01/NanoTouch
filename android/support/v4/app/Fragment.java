...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    private static final C0058q<String, Class<?>> sClassMap = new C0058q();
    ...
    class C00331 implements FragmentContainer {
        C00331() {
        }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachActivity(this.mActivity, new C00331(), this);
    }
