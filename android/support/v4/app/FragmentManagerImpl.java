...
final class FragmentManagerImpl extends FragmentManager implements Factory {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00371();
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        PrintWriter printWriter = new PrintWriter(new C0064e(TAG));
    ...
    public void popBackStack() {
        enqueueAction(new C00382(), HONEYCOMB);
    }
    ...
    public String toString() {
        ...
        if (this.mParent != null) {
            C0063d.m97a(this.mParent, stringBuilder);
        } else {
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    for (i2 = 0; i2 < fragmentManagerState.mBackStack.length; i2++) {
                        ...
                        if (DEBUG) {
                            ...
                            instantiate2.dump("  ", new PrintWriter(new C0064e(TAG)), HONEYCOMB);
                        }
    ...
    public View onCreateView(String str, Context context, AttributeSet attributeSet) {
        ...
        Fragment fragment;
        if (resourceId != -1) {
            Fragment findFragmentById = findFragmentById(resourceId);
        } else {
            Object obj = view;
        }
