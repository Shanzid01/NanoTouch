...
public abstract class C0174z extends bb {
    ...
    protected void onTargetFound(View view, bd bdVar, bc bcVar) {
        ...
        if (calculateTimeForDeceleration > 0) {
            bcVar.m1633a(-calculateDxToMakeVisible, -calculateDyToMakeVisible, calculateTimeForDeceleration, this.mDecelerateInterpolator);
        }
    }

    protected void onSeekTargetStep(int i, int i2, bd bdVar, bc bcVar) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        ...
        if (this.mInterimTargetDx == 0 && this.mInterimTargetDy == 0) {
            updateActionForInterimTarget(bcVar);
        }
    }
    ...
    protected void updateActionForInterimTarget(bc bcVar) {
        ...
        bcVar.m1633a((int) (((float) this.mInterimTargetDx) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) this.mInterimTargetDy) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) calculateTimeForScrolling(TARGET_SEEK_SCROLL_DISTANCE_PX)) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
    }
